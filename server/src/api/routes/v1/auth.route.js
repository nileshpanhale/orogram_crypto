 ...
 * @apiError (Bad Request 500)  message  Error during registration
 */
...
/**
 * @api {post} v1/auth/loginWithUserId Login with UserId
 * @apiDescription Login with User id.
 * @apiVersion 1.0.0
 * @apiName loginWithUserId
 * @apiGroup Auth
 * @apiPermission public
 *
 ...
 * @apiError (Unauthorized 401)  Unauthorized     Incorrect email or password
 */
router.route('/loginWithUserId')
  .post(validate(loginWithUserId), controller.loginWithUserId);

/**
 * @api {post} v1/auth/resendVerificationEmail Resend Verification Email
 * @apiDescription Resend verification email.
 * @apiVersion 1.0.0
 ...
 *
 * @apiSuccess  {String}  message     Mail Sent
 *
 * @apiError (Bad Request 400)  ValidationError  Some parameters may contain invalid values
 * @apiError (Unauthorized 401)  Unauthorized     Incorrect email
 */
router.route('/resendVerificationEmail')
  .post(validate(resendVerificationEmail), controller.resendVerificationEmail);


/**
 * @api {post} v1/auth/refreshToken Refresh Token
...
router.route('/google')
  ...
  /**
 * @api {post} v1/auth/googleAuth 2-step verification
 * @apiDescription verify user and get an accessToken
 * @apiVersion 1.0.0
 * @apiName 2-step verification
 * @apiGroup Auth
 * @apiPermission public
 *
 * @apiParam  {String}    email     User's email
 * @apiParam  {String}    code      Code shown in google authenticator app
 *
 * @apiSuccess  {String}  token.tokenType     Access Token's type
 * @apiSuccess  {String}  token.accessToken   Authorization Token
 * @apiSuccess  {String}  token.refreshToken  Token to get a new accessToken
 ...
 *
 * @apiError (Bad Request 400)  ValidationError  Some parameters may contain invalid values
 * @apiError (Unauthorized 401)  Unauthorized     Incorrect code
 */
router.route('/googleAuth')
  .post(controller.twoFactorAuth);


router
  .route('/forgotPassword')
/**
 * @api {post} v1/auth/forgotPassword forgot Password
 * @apiDescription Get an accessToken
 * @apiVersion 1.0.0
 ...
 *
 * @apiParam  {String}         email              User's email
 * @apiParam  {String}         phrase              User's phrase
